...
class SpiderAdmin(admin.ModelAdmin):
    ...
    def set_faulty(self, request, qs):
        qs.update(faulty=True)
        n = qs.count()
        self.message_user(request, f'{n} spiders set as faulty')

    def set_not_faulty(self, request, qs):
        qs.update(faulty=False)
        n = qs.count()
        self.message_user(request, f'{n} spiders set as not faulty')

    def set_as_crawlera_spider(self, request, qs):
        qs.update(crawlera_spider=True)
        n = qs.count()
        self.message_user(request, f'{n} spiders set as Crawlera spiders.')

    def set_as_not_crawlera_spider(self, request, qs):
        qs.update(crawlera_spider=False)
        n = qs.count()
        self.message_user(request, f'{n} spiders set as not Crawlera spiders.')
    ...
    actions = [
        ...
        'set_faulty',
        'set_not_faulty',
        'set_as_crawlera_spider',
        'set_as_not_crawlera_spider',
    ]
